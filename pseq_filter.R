...
# ATLAS SUBSET
# Relative abundance
atlas.recode.country.comp.pseq <- microbiome::transform(mypseq[["atlas.recode.country.pseq" ]], "compositional")

# Filtering based on filter.features for siamcat
# siamcat <- filter.features(siamcat, cutoff=1e-04, filter.method = 'abundance', feature.type = 'original')

# Filtered such that only OTUs with a mean greater than 1e-05 are kept.
atlas.recode.country.comp.filter.pseq = filter_taxa(atlas.recode.country.comp.pseq, function(x) mean(x) > 1e-04, TRUE)
atlas.recode.country.filter.pseq = filter_taxa(mypseq[["atlas.recode.country.pseq" ]], function(x) mean(x) > 1e-04, TRUE)

atlas.recode.country.comp.core.pseq <- core(atlas.recode.country.comp.pseq, detection = 0, prevalence = .5)


mypseq[["atlas.recode.country.comp.pseq"]] <- atlas.recode.country.comp.pseq
mypseq[["atlas.recode.country.comp.filter.pseq"]] <- atlas.recode.country.comp.filter.pseq
mypseq[["atlas.recode.country.comp.core.pseq"]] <- atlas.recode.country.comp.core.pseq
mypseq[["atlas.recode.country.filter.pseq"]] <- atlas.recode.country.filter.pseq
...
sample_data(mypseq[["atlas.recode.country.comp.pseq"]])[c(4:6,8:10)] = NULL
sample_data(mypseq[["atlas.recode.country.comp.filter.pseq"]] )[c(4:6,8:10)] = NULL
sample_data(mypseq[["atlas.recode.country.filter.pseq"]])[c(4:6,8:10)] = NULL
